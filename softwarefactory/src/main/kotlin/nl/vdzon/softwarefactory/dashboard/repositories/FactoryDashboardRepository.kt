...
class FactoryDashboardRepository(
     ...
     * events samen liepen ooit ruim over de 8 MB-grens van het toenmalige transport heen — de hele
     * story-detailpagina bleef dan zonder data hangen. Kap de payload
