...
- Signaleer ontbrekende of verouderde integratietest-scenario's (geen tests zelf toevoegen —
  dat is code-verandering; dat hoort in de voorgestelde vervolg-story).
