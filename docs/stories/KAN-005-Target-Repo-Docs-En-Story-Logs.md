...
[x]: Target-repo docs bootstrap vanuit de applicatie maken
...
[x]: implement docs bootstrap to copy skeleton into target repos
...
- De applicatie kopieert de skeleton naar een target-repo zonder bestaande bestanden te overschrijven, zodat bootstrap veilig op bestaande repositories kan draaien.
...
- De docs-bootstrap is getest op een tijdelijke directory; alle verplichte `docs/factory` bestanden en `docs/stories/.gitkeep` werden aangemaakt.
