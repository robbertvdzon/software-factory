...
| softwarefactory / `robbertvdzon` | `software-factory` / `main` | protected `Backend verification`; `mvn verify` | VER-01 [PR #76](https://github.com/robbertvdzon/software-factory/pull/76) | `d4f3280` → volgt bij merge | schema 1, `repository-maven-verify`, geldig op inhoud-SHA `b14ebea`; herhaling op gemergede `main` verplicht | enforcement landt samen met geldige config |
