...
/**
 * Tijdrekenen voor de nachtelijke/audit-scheduler. De factory-klok draait in UTC, maar de gebruiker
 * stelt de start-/summary-tijd in lokale NL-tijd (`Europe/Amsterdam`) in. Deze utility rekent
 * DST-correct tussen beide en is volledig deterministisch testbaar via een injecteerbare [Clock].
 *
 ...
 */
@Component
class FactoryTime(private val clock: Clock = Clock.systemUTC()) {
