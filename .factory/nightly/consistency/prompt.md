# Consistentie: afwijkende patronen — audit
...
## Scope
- Zoek inconsistente patronen in de code t.o.v. de norm in de rest van de codebase:
  naamgeving, structuur, error-handling, logging, API-conventies.
- Plekken waar hetzelfde probleem op meerdere manieren is opgelost.
